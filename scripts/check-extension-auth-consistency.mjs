#!/usr/bin/env node
/**
 * Ensures the Chromium extension auth wiring stays aligned with @helvety/shared policy:
 * - no legacy client-only OTP anchor
 * - weekly proof storage + header usage
 * - getUser()-first session resolution
 */
