...
export const FORBIDDEN_KEYS_BY_APP = {
  ...
  notes: ["SUPABASE_SECRET_KEY", ...FORBIDDEN_ANALYTICS_ENV_KEYS],
  tasks: ["SUPABASE_SECRET_KEY", ...FORBIDDEN_ANALYTICS_ENV_KEYS],
  contacts: ["SUPABASE_SECRET_KEY", ...FORBIDDEN_ANALYTICS_ENV_KEYS],
  links: ["SUPABASE_SECRET_KEY", ...FORBIDDEN_ANALYTICS_ENV_KEYS],
  docs: ["SUPABASE_SECRET_KEY", ...FORBIDDEN_ANALYTICS_ENV_KEYS],
  pdf: [
    "SUPABASE_SECRET_KEY",
    "DEVICE_TRUST_COOKIE_SECRET",
    ...FORBIDDEN_ANALYTICS_ENV_KEYS,
