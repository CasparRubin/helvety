...
export const EXPECTED_KEYS_BY_APP = {
  ...
  "image-editor": [...PUBLIC_SUPABASE_KEYS, ...UPSTASH_COOKIE_KEYS],
  ocr: [...PUBLIC_SUPABASE_KEYS, ...UPSTASH_COOKIE_KEYS],
...
export const FORBIDDEN_KEYS_BY_APP = {
  ...
  auth: [...HELVETY_FORBIDDEN_ANALYTICS_ENV_KEYS],
  store: [
    "DEVICE_TRUST_COOKIE_SECRET",
    ...HELVETY_FORBIDDEN_ANALYTICS_ENV_KEYS,
  ],
  notes: ["SUPABASE_SECRET_KEY", ...HELVETY_FORBIDDEN_ANALYTICS_ENV_KEYS],
