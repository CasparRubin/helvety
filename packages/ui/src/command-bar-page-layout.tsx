...
export function CommandBarPageLayout({
  ...
  return (
    ...
    >
      ...
      <ScrollArea
        className={cn(
          "flex min-h-0 flex-1 flex-col [&>[data-radix-scroll-area-viewport]]:max-h-full [&>[data-radix-scroll-area-viewport]]:min-h-0 [&>[data-radix-scroll-area-viewport]]:flex-1",
          scrollAreaClassName
        )}
