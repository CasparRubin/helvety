import { DEFAULT_CONTACT_CATEGORY_ID } from "../e2ee-entity-defaults";
...
/**
 * Decryption for E2EE entity reads (Web Crypto).
 * Plaintext exists in client memory while unlocked only.
 */
