            ...
            <SheetContent side="right">
              <SheetHeader>
                ...
                <SheetDescription className="sr-only">
                  Image Upscaler navigation menu
                </SheetDescription>
              </SheetHeader>
