...
- Read paths use authenticated read model with rate limiting. Library prefetch GET routes use `@helvety/shared/encrypted-prefetch-api` (`RATE_LIMITS.PREFETCH`, explicit column selects).
