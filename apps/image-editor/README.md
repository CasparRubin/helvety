...
- Border, highlight, and blur regions support straight or rounded corners (`cornerRadius`, default `8`); rounded highlights (`cornerRadius > 0`, including new highlights) use an even-odd cutout overlay, straight highlights (`cornerRadius === 0`) use dim strip geometry ([`lib/spotlight-rects.ts`](lib/spotlight-rects.ts) / [`lib/spotlight-cutout.ts`](lib/spotlight-cutout.ts))
