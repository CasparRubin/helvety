 ...
 * Editor chrome (File/Format/Insert title-bar menus, formatting toolbar; doc icon and Help hidden) is
 * themed in `styles/docx-editor-helvety-bridge.css` on `.ep-root` (Layers 5–8).
 */
