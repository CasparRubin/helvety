...
7. Eigenpal title bar: **Format** and **Insert** visible; no default doc icon column, no **Help** menu, no **comment** UI (Helvety command bar owns file actions)
