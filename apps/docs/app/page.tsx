 ...
 * New resets to a fresh blank document. Theme: shared public shell + navbar ThemeSwitcher; Eigenpal bridge in `styles/docx-editor-helvety-bridge.css` (File/Format/Insert menus, title-bar document actions).
 */
