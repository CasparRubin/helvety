...
/**
 * Next.js configuration for the Store app (product store)
 *
...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const headers = [
      ...
      },
      {
        ...
        value: [
          ...
          // No blob: needed — store app does not render user-generated blobs
    ...
    if (!isDevelopment) {
      ...
      headers.push({
        // "credentialless" allows third-party resources (Stripe.js, Vercel Analytics, etc.)
