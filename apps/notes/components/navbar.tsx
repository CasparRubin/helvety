...
/**
 * Main navigation bar component for the Notes app
 *
 * Features:
 * - App switcher for navigating between Helvety ecosystem apps
 * - Logo and branding with "Notes" label
            ...
            {!encryptionLoading && isEncryptedForCurrentUser && (
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs space-y-2 p-3">
                  ...
                  <p>
                    Sensitive note content fields are encrypted on your device
              ...
              <DialogContent>
                <DialogHeader className="pr-8">
                  ...
                  <DialogDescription className="pt-2">
                    Privacy-focused notes management with client-side encryption
