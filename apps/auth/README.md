...
Notable tests include login-step mapping and auth-step resolution (`lib/login-flow-stepper.test.ts`, `lib/auth-step.test.ts`), login stepper layout and Light Pillar contrast markup (`components/encryption-stepper.test.tsx`).
