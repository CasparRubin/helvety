...
A privacy-focused task management app with client-side encryption for sensitive fields. Required structural metadata remains plaintext for app functionality. Engineered, Designed & Made in Switzerland.
...
Run these commands from `apps/tasks`:
...
**Helvety Tasks is free to use with no paid tiers or subscriptions.** Source code is available under the MIT License, and the software is provided "as is" without warranty.
