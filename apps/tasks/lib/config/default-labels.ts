...
/**
 * DB-required default label ID for items.
 * The items table CHECK constraint (items_label_id_fixed_check) only allows
 * this value when label_id is used. Use when creating items without a label.
 */
