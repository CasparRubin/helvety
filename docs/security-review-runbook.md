...
### Vercel dashboard (manual, all eleven zone projects)

Applies to every Vercel project in [`vercel-monorepo-apps.md`](./vercel-monorepo-apps.md), including `helvety-ocr`.
