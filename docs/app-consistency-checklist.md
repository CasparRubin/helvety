...
| Hook errors           | `reportE2eeHookError` / `reportE2eeActionFailure` in list hooks (`useEncryptedSortableItems`) and optional single-entity hooks (`useEncryptedSingleItem` via `useItem` / `useContact`)                                                                                                                  | E2EE vault apps (tasks, notes, contacts)                           |
