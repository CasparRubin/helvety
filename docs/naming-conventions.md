...
| Encryption (non-E2EE)   | State **browser-local** / **not sent to Helvety** for local-only flows; never imply full-app E2EE for PDF, Image Upscaler, Image Editor, Store, or gateway                                                                                                                                                                                                                                     |
