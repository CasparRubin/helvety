...
| Root security overrides              | `hono@4.12.27`, `vite@8.1.0`, `rollup@4.62.2`, `protobufjs@7.6.4`, `dompurify@3.4.11`, `js-yaml@4.2.0`, `undici@7.28.0`, `@babel/core@8.0.1`, `postcss@8.5.15`, `qs@6.15.3` | npm                            | `bun audit`                                                      | Bump root `overrides`; `bun install`                                             | Transitive CVEs             |
