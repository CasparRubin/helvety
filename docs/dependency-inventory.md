...
| Supabase JS client                   | `^2.108.1` (drift; security floor `2.108.1`; root override `2.108.1`)                          | supabase-js                    | https://github.com/supabase/supabase-js/releases                 | Bump in drift script + apps; `deps:security:floors`                              | Auth/API                    |
...
| Root security overrides              | `hono@4.12.25`, `vite@8.0.16`, `rollup@4.62.0`, `pdfjs-dist@6.0.227`                           | npm                            | `bun audit`                                                      | Bump root `overrides`; `bun install`                                             | Transitive CVEs             |
...
| `onnxruntime-web`           | `^1.26.0` — `apps/image-upscaler/package.json`                          | Microsoft ONNX Runtime                  | https://github.com/microsoft/onnxruntime/releases        | Bump package; run `predev`/`prebuild` (both invoke `copy-ort-runtime.mjs`) or `node scripts/copy-ort-runtime.mjs`; verify worker `wasmPaths` and CSP | WASM path/API changes               |
...
| Name                           | Current pin                                                                               | Upstream             | Check URL                                        | Update procedure                                                               | Risk                 |
| ------------------------------ | ----------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------ | -------------------- |
| `@eigenpal/docx-editor-react`  | `^1.4.0` — `apps/docs/package.json`                                                       | eigenpal/docx-editor | https://github.com/eigenpal/docx-editor/releases | npm bump; **Eigenpal upgrade checklist** in `apps/docs/README.md`; theme tests | UI/theme regressions |
