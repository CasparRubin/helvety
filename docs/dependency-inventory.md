...
| Root security overrides              | `hono@4.12.25`, `vite@8.0.16`, `rollup@4.62.0`, `pdfjs-dist@6.0.227`, `protobufjs@7.6.4`, `dompurify@3.4.11`, `js-yaml@4.2.0` | npm                            | `bun audit`                                                      | Bump root `overrides`; `bun install`                                             | Transitive CVEs             |
