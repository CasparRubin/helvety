...
| Root security overrides              | `hono@4.12.25`, `vite@8.0.16`, `rollup@4.62.0`, `pdfjs-dist@6.0.227`, `protobufjs@7.6.4`, `dompurify@3.4.11`, `js-yaml@4.2.0`, `undici@7.28.0`, `@babel/core@8.0.1` | npm                            | `bun audit`                                                      | Bump root `overrides`; `bun install`                                             | Transitive CVEs             |
...
| Name                           | Current pin                                                                               | Upstream             | Check URL                                        | Update procedure                                                               | Risk                 |
| ------------------------------ | ----------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------ | -------------------- |
| `@eigenpal/docx-editor-react`  | `^1.6.2` — `apps/docs/package.json`                                                       | eigenpal/docx-editor | https://github.com/eigenpal/docx-editor/releases | npm bump; **Eigenpal upgrade checklist** in `apps/docs/README.md`; theme tests | UI/theme regressions |
