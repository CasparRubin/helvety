...
| Supabase JS client                   | `^2.110.0` (drift; security floor `2.110.0`; root override `2.110.0`)                                                                                                                                | supabase-js                    | https://github.com/supabase/supabase-js/releases                 | Bump in drift script + apps; `deps:security:floors`                              | Auth/API                    |
...
| Root security overrides              | `hono@4.12.28`, `vite@8.1.3`, `rollup@4.62.2`, `protobufjs@7.6.4`, `dompurify@3.4.11`, `js-yaml@4.2.0`, `undici@7.28.0`, `@babel/core@8.0.1`, `postcss@8.5.16`, `qs@6.15.3`, `brace-expansion@5.0.7` | npm                            | `bun audit`                                                      | Bump root `overrides`; `bun install`                                             | Transitive CVEs             |
